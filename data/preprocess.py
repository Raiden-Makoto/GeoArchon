...
ELEMENT_PROPERTIES = {
    'Al': (143, 3, 1.61, 933),  'Co': (125, 9, 1.88, 1768),
    'Cr': (128, 6, 1.66, 2180), 'Fe': (126, 8, 1.83, 1811),
    'Ni': (124, 10, 1.91, 1728),'Cu': (128, 11, 1.90, 1357),
    'Mn': (127, 7, 1.55, 1519), 'Ti': (147, 4, 1.54, 1941),
    'V':  (134, 5, 1.63, 2183), 'Nb': (146, 5, 1.60, 2750),
    'Mo': (139, 6, 2.16, 2896), 'Zr': (160, 4, 1.33, 2128),
    'Hf': (159, 4, 1.30, 2506), 'Ta': (146, 5, 1.50, 3290),
    'W':  (139, 6, 2.36, 3695), 'C':  (77,  4, 2.55, 3823),
    'B':  (82,  3, 2.04, 2349), 'Si': (111, 4, 1.90, 1687)
}
